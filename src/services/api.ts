...
class ApiService {
  ...
  async generateSummary(
    ...
    return this.makeRequest<Summary>('/summary/generate', 'POST', {
      content: transcript,
      metadata: {
        ...videoMetadata,
        source: 'youtube'
  ...
  async saveSummary(summary: Summary, token: string): Promise<ApiResponse<{ id: string }>> {
    return this.makeRequest<{ id: string }>('/summary/save', 'POST', summary, token);
  }
